...
public class Constants {
    ...
    public static final String SUGGESTED_RECIPES_BY_INGREDIENTS_ENDPOINT = "recipes/findByIngredients" + BuildConfig.SPOONACULAR_KEY + "&sort=min-missed-ingredients";
    ...
    public static final String RECIPE_DETAILS_ENDPOINT = "recipes/{id}/information" + BuildConfig.SPOONACULAR_KEY;
